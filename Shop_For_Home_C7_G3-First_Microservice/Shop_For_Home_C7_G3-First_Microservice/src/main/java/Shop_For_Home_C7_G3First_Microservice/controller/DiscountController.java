...
import Shop_For_Home_C7_G3First_Microservice.entity.Discount;
import Shop_For_Home_C7_G3First_Microservice.helper.ResponseMessage;
...
public class DiscountController {
	...
	public ResponseEntity<ResponseMessage> createCoupon(@PathVariable("code") String code,@RequestBody List<String> emails) {
    	...
    	String url="http://localhost:8081/c7g3/add/coupon/"+code;
    ...
    public List<Discount> orderList() {
    	...
    	String url="http://localhost:8081/c7g3/coupon/alllist";
	...
	public ResponseEntity<Discount> deleteCoupon(@PathVariable("code") Long code) {
    	...
    	String url="http://localhost:8081/c7g3/delete/coupon/"+code;
